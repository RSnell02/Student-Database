...
namespace Student_Database_Application {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class studentDataTable : global::System.Data.TypedTableBase<studentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public studentRow AddstudentRow(int StudentID, string FName, string LName, string Year, string City, string State) {
...
namespace Student_Database_Application.Database1DataSetTableAdapters {
    ...
    public partial class studentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[student] WHERE (([StudentID] = @Original_StudentID) AND ([FNam" +
                "e] = @Original_FName) AND ([LName] = @Original_LName) AND ([Year] = @Original_Ye" +
                "ar) AND ([City] = @Original_City) AND ([State] = @Original_State))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[student] ([StudentID], [FName], [LName], [Year], [City], [Stat" +
                "e]) VALUES (@StudentID, @FName, @LName, @Year, @City, @State);\r\nSELECT StudentID" +
                ", FName, LName, Year, City, State FROM student WHERE (StudentID = @StudentID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[student] SET [StudentID] = @StudentID, [FName] = @FName, [LName] = @LName, [Year] = @Year, [City] = @City, [State] = @State WHERE (([StudentID] = @Original_StudentID) AND ([FName] = @Original_FName) AND ([LName] = @Original_LName) AND ([Year] = @Original_Year) AND ([City] = @Original_City) AND ([State] = @Original_State));
SELECT StudentID, FName, LName, Year, City, State FROM student WHERE (StudentID = @StudentID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Student_Database_Application.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentID, FName, LName, Year, City, State FROM dbo.student";
        ...
        public virtual int Delete(int Original_StudentID, string Original_FName, string Original_LName, string Original_Year, string Original_City, string Original_State) {
        ...
        public virtual int Insert(int StudentID, string FName, string LName, string Year, string City, string State) {
        ...
        public virtual int Update(int StudentID, string FName, string LName, string Year, string City, string State, int Original_StudentID, string Original_FName, string Original_LName, string Original_Year, string Original_City, string Original_State) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FName, string LName, string Year, string City, string State, int Original_StudentID, string Original_FName, string Original_LName, string Original_Year, string Original_City, string Original_State) {
            return this.Update(Original_StudentID, FName, LName, Year, City, State, Original_StudentID, Original_FName, Original_LName, Original_Year, Original_City, Original_State);
        }
    }
